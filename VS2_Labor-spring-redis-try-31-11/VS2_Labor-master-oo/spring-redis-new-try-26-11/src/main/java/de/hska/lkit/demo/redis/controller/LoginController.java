...
public class LoginController {
	...
	public String usersHOme( @ModelAttribute("user") @Valid User user, Model model,@ModelAttribute Post post ) {
	...
	//!!!!!!!!!!!!!!!!!!!!! Methode soll geändert werden , da simplesecurity nun auch an logout gebunden wurde im webconfig.java 
	//kann ich auf den name zugrefen ohne cokie abzufragen
	@RequestMapping(value="/logout", method = RequestMethod.GET)
	public String logoutPage (HttpServletRequest req, HttpServletResponse res) {
		//System.out.println("i am simplesecurty logout: " + SimpleSecurity.getName());
