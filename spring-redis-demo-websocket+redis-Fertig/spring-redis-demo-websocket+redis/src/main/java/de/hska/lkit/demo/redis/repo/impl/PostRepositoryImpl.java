		...
		public void savePost(Post post) {
			...
			*/
			...
			srt_listOps.leftPush(KEY_LIST_ALL_PAST+post.getAuthorId(), post.getPostId());
			 for(String lisofUserPast : stringRedisTemplate.opsForSet().members("user:" + post.getAuthorId() +":follower")) {
		            srt_listOps.leftPush(KEY_LIST_ALL_PAST+lisofUserPast, post.getPostId());
		        }
