...
import de.hska.lkit.demo.redis.repo.impl.RedisRepository;
...
public class LoginController {
	...
	public String register(@ModelAttribute User user, HttpServletResponse response, Model model) {
		...
		} else if(user==null||user.getUsername().isEmpty()||user.getPassword().isEmpty()||user.getUsername().trim().isEmpty()){
			return "redirect:login";
		}
		else {
	...
	public String logout(@ModelAttribute User user, Model model, HttpServletRequest request, HttpServletResponse response) {
