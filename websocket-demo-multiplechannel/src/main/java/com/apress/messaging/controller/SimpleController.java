...
public class SimpleController {
	...
	this.template.convertAndSend("/topic/chat-room2", msg);
	this.template.convertAndSend("/topic/chat-room5", msg);
	this.template.convertAndSend("/topic/chat-room3", msg);
	this.template.convertAndSend("/topic/chat-room4", msg);
